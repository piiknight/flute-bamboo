                    ...
                    <nav>
                        <ul class="pagination">
		                    <c:if test="${not empty previous }">
					            <li ><a href="${pageContext.request.contextPath}/page/${previous}">&lsaquo;&lsaquo;&lsaquo;</a></li>
					         </c:if>
					         ...
					         <c:if test="${not empty next }">
					            <li ><a href="${pageContext.request.contextPath}/page/${next}">&rsaquo;&rsaquo;&rsaquo;</a></li>
					         </c:if>
		                </ul>
                    </nav>
                </div>