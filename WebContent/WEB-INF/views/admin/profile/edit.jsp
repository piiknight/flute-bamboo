            ...
            <div class="col-md-12">
               <div class="card">
                  ...
                  <div class="frame-content">
                  	 <a href="${pageContext.request.contextPath }/admin/profile/password" class="btn btn-primary">Đổi mật khẩu</a>
                  	 <a href="${pageContext.request.contextPath }/admin/profile/bill" class="btn btn-primary">Xem lịch sử mua hàng</a>
                  	 <br /><br />
                     ...
                     <form id="form-add" class="my-form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <select name="role_id" class="my-input">
                        	<c:forEach items="${roles }" var="role">
                        		<c:if test="${role.role_id == u.role_id }">
