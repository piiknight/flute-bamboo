         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card">
                  ...
                  <form action="${pageContext.request.contextPath }/admin/profile/bill/delete-all">
                  <div class="content table-responsive table-full-width">
                     <table class="table table-striped">
                        ...
                        <c:forEach items="${bills }" var="bill">
                           <tr>
                              ...
                              <td>
                              	<fmt:formatDate value="${bill.date_create }" pattern="HH:mm dd-MM-yyyy"/>
                              </td>
                              <td>${bill.pname }</td>
                              <td>
                              ...
                              <td>
                                 <a href="${pageContext.request.contextPath }/admin/profile/bill/detail/${bill.bid }">
                                 <i class="ti-pencil"></i>
                                 <span>Xem</span>
                                 </a>
                                 <a onclick="return confirm('Bạn có chắc muốn xóa ?')" href="${pageContext.request.contextPath }/admin/profile/bill/del/${bill.bid }">
                                 <i class="ti-trash"></i>
                                 <span>Xóa</span>
                                 </a>
                              </td>
                     ...
                     <div class="my_pagination pagination">
                        ...
                        <a id="backlistpage" href="javascript:;">&laquo;</a>
				 		<c:if test="${page != 1 }">
				 		<a href="${pageContext.request.contextPath }/admin/profile/bill/${page - 1 }">&lsaquo;</a>
				 		</c:if>
				 		<c:forEach begin="1" end="${sumPage }" var="i">
						<a id="idpage${i }" ${ (page == i )?"class='active'":"" } href="${pageContext.request.contextPath }/admin/profile/bill/${i }">${i }</a>
						</c:forEach>
						<c:if test="${page != sumPage }">
				 		<a href="${pageContext.request.contextPath }/admin/profile/bill/${page + 1 }">&rsaquo;</a>
				 		</c:if>
