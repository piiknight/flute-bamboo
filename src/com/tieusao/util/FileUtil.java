...
public final class FileUtil {
	...
	public static String upload(CommonsMultipartFile cmf, HttpServletRequest request, String dir) throws IOException {
		fileName = cmf.getOriginalFilename();
		String appPath = request.getServletContext().getRealPath("");
		String dirPath = appPath + Defines.DIR_UPLOAD + File.separator + dir;
	...
	public static void delete(String fileName, HttpServletRequest request, String dir) throws IOException {
		if (!"".equals(fileName)) {
			File file = new File(request.getServletContext().getRealPath("") + Defines.DIR_UPLOAD + File.separator + dir + File.separator + fileName);
			file.delete();
		} else {
			throw new IOException();
		}
